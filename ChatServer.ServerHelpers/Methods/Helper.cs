...
namespace ChatServer.ServerHelpers.Methods
{
	...
	public static class Helpers
	{
		...
		public static string GetDataFromFrame(byte[] Data, int length)
		{
			Data = Data.SubArray(0, length);
			return GetDataFromFrame(GetFrameData(Data), Data);
		}
		public static string GetDataFromFrame(SFrameMaskData frameData, byte[] Data)
		{
